...
does not inherit for free and is [OQ 47](../rfcs/0006-multi-process-one-data-directory.md).
...
short-lived ones talk to it", and [OQ 47](../rfcs/0006-multi-process-one-data-directory.md) asks whether
...
offline `reconfigure` of [OQ 5](../rfcs/0014-offline-reconfigure.md) and the format
...
| Service API reachable without auth | v1 binds loopback by default; a non-loopback bind without the auth setting is a startup warning ([OQ 38](../rfcs/0007-service-api-auth.md)) |
...
- Library-first or service-first - decided: option A ([ADR 0007](../adrs/0007-the-library-is-the-primary-surface.md);
  [RFC 0001](../rfcs/0001-library-first-or-service-first.md) decided, [OQ 15](../adrs/0007-the-library-is-the-primary-surface.md) resolved).
