...
| # | Status | Title |
|---|---|---|
| [0001](0001-journal-core.md) | Shipped (single-member) | Journal core: append-only entries, slots, and the hash chain |
| [0002](0002-ttl-and-staleness.md) | Shipped (single-member) | TTL and staleness: the only two mutations |
| [0003](0003-membership-and-leadership.md) | Shipped (phases 1–6; known issue: three-member merge) | Membership and leadership: seniority, configured authorities, and scaling 1 → n |
| [0004](0004-settings.md) | Shipped | Settings: the journal configures itself through its own chain |
| [0005](0005-embedding-the-library-as-the-product.md) | Shipped (steps 1–3) | Embedding: the library as the product, the node binary, and hosts (clanker first) |
