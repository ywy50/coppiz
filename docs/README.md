...
|---|---|
| what this is and why it exists | [PRD 0001 Problem](prds/0001-ledger-core.md#problem), then [research 0001](research/0001-evidence-carried-from-clanker-rfc-0019.md) |
| the data model | [PRD 0001](prds/0001-ledger-core.md) — entries, slots, chain, control entries |
...
where the ledger put it — `(epoch, seq)`, assigned and signed by the leader of
...
**The rule: everything the ledger knows about itself is in the chain.**
