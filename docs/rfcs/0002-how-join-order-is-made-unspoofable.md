...
concurrent-join ordering is [OQ 58](../prds/0003-membership-and-leadership.md), resolved the same
...
seniority resets on rejoin ([OQ 4](0013-seniority-on-rejoin.md)).
...
- Should concurrent `join`s within one leader's batch be ordered by the
  ...
  discretion entirely? ([OQ 58](../prds/0003-membership-and-leadership.md)); the operator; cheap
  to decide either way)
- Seniority on rejoin ([OQ 4](0013-seniority-on-rejoin.md)).
