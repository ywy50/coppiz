...
`zig build test` is today's merge gate ([OQ 45](docs/rfcs/0036-ci-toolchain-pin.md)): it
...
deterministic simulator, [OQ 27](docs/prds/0003-membership-and-leadership.md)), and the node
...
| [docs/research/](docs/research/) | evidence, with read dates; open measurement questions live here too |
